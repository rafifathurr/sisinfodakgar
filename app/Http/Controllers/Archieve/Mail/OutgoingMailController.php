...
class OutgoingMailController extends Controller
{
    ...
    {
        $data['dt_route'] = route('archieve.mail.outgoing-mail.dataTable'); // Route DataTables
        return view('archieve.mail.outgoing_mail.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('archieve.mail.outgoing_mail.create', $data);
    }
    ...
    public function dataTable()
    {
        ...
        $dataTable = DataTables::of($outgoing_mails)
            ...
            ->addColumn('action', function ($data) {
                $btn_action = '<a href="' . route('archieve.mail.outgoing-mail.show', ['id' => $data->id]) . '" class="btn btn-sm btn-primary ms-2 mb-1" title="Detail"><i class="bi bi-eye"></i></a>';
                $btn_action .= '<a href="' . route('archieve.mail.outgoing-mail.edit', ['id' => $data->id]) . '" class="btn btn-sm btn-warning ms-2 mb-1" title="Ubah"><i class="bi bi-pencil-square"></i></a>';
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($outgoing_mail) {
                // Image Path
                $path = 'public/archieve/mail/outgoing-mail';
                $path_store = 'storage/archieve/mail/outgoing-mail';
                ...
                //     DB::commit();
                //     return redirect()
                //         ->route('archieve.mail.outgoing-mail.show', ['id' => $outgoing_mail->id])
    ...
    public function show(string $id)
    {
        try {
            ...
            return view('archieve.mail.outgoing_mail.detail', $data);
        } catch (\Exception $e) {
            return redirect()
                ->back()
                ->with(['failed' => $e->getMessage()]);
    ...
    public function edit(string $id)
    {
        try {
            ...
            $data['classifications'] = Classification::whereNull('deleted_at')->get();
            $data['type_mail_contents'] = TypeMailContent::whereNull('deleted_at')->get();
            return view('archieve.mail.outgoing_mail.edit', $data);
        } catch (\Exception $e) {
            return redirect()
                ->back()
                ->with(['failed' => $e->getMessage()]);
                ...
                if (!empty($request->allFiles())) {
                    ...
                    if (Storage::exists($path . '/' . $file_name)) {
                        ...
                        if ($outgoing_mail_attachment_update) {
                            DB::commit();
                            return redirect()
                                ->route('archieve.mail.outgoing-mail.show', ['id' => $id])
