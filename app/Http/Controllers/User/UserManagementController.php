    ...
    public function dataTable()
    {
        ...
        $dataTable = DataTables::of($list_of_users)
            ...
            ->addColumn('action', function ($data) {
                ...
                $btn_action .= '<a href="' . route('user-management.show', ['id' => $data->id]) . '" class="btn btn-sm btn-primary ms-2 mb-1" title="Detail"><i class="bi bi-eye"></i></a>';
                $btn_action .= '<a href="' . route('user-management.edit', ['id' => $data->id]) . '" class="btn btn-sm btn-warning ms-2 mb-1" title="Ubah"><i class="bi bi-pencil-square"></i></a>';
